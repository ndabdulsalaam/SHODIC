"""Periodic update checks for SHODIC data sources."""
...
def schedule_defaults() -> list[dict[str, Any]]:
    ...
    return [
        {
            "name": "SHODIC weekly NAFDAC delta",
        ...
        {
            "name": "SHODIC monthly NAFDAC full scrape",
            "func": "django.core.management.call_command",
        ...
        {
            "name": "SHODIC weekly OpenFDA recent pull",
            "func": "django.core.management.call_command",
        ...
        {
            "name": "SHODIC annual static source check",
            "func": "shodic.ingestion.update_checker.check_all_sources",
            "args": "",
            "schedule_type": "Y",
            "next_run": next_run,
        },
