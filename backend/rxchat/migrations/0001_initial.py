# Generated manually for the RxChat free-session schema.
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-updated_at'],
                'indexes': [models.Index(fields=['session_key', '-updated_at'], name='rxchat_conv_sess_upd_idx')],
            },
        ),
        migrations.CreateModel(
            name='RawSourceData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('raw_source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chunks', to='rxchat.rawsourcedata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='rxchat.conversation')),
            ],
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['conversation', 'created_at'], name='rxchat_msg_conv_time_idx')],
            },
        ),
    ]
